...
url_get = 'https://yandex.ru/search/xml?user=user&key=ключ&query=' + url_enc + '&lr=213&l10n=ru&sortby=rlv&filter=strict&groupby=attr%3Dd.mode%3Ddeep.groups-on-page%3D50.docs-in-group%3D1'
